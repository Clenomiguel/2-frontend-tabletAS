...
class ProdutoCompleto {
  ...
  factory ProdutoCompleto.fromJson(Map<String, dynamic> json) {
    // O produto pode vir no root do JSON ou dentro de json['produto']
    final produtoData = json['produto'] is Map<String, dynamic>
        ? json['produto'] as Map<String, dynamic>
        : json;

    // Debug: verificar dados
    print('🔍 ProdutoCompleto.fromJson:');
    print('   - json.keys: ${json.keys.toList()}');
    print('   - produtoData["grid"]: ${produtoData["grid"]}');
    print('   - produtoData["nome"]: ${produtoData["nome"]}');
...
class ProdutoComplemento {
  ...
  final String? produtoNome; // Nome do produto pai
  ...
  factory ProdutoComplemento.fromJson(Map<String, dynamic> json) {
    ...
    return ProdutoComplemento(
      ...
      produtoNome: json['produto_nome'], // Mapeando produto_nome
