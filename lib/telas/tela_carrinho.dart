...
class _CartScreenState extends State<CartScreen> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Coluna direita: Preço + Quantidade + Remover
                Column(
            ...
            // Complementos com controle de quantidade
            if (item.complementos.isNotEmpty) ...[
              const SizedBox(height: 12),
              const Divider(color: _bgDark, height: 1),
              const SizedBox(height: 12),
              ...item.complementos.asMap().entries.map((entry) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          comp.nome,
                          style:
                              const TextStyle(color: _textWhite, fontSize: 14),
                        ),
                      ),
                      // Controle de quantidade do complemento
                      _buildQuantityControlSmall(
                        quantidade: comp.quantidade,
                        onDecrease: () => cart.updateComplementQuantity(
                          item.id,
                          comp.complementoGrid,
                          comp.quantidade - 1,
                        ),
                        onIncrease: () => cart.updateComplementQuantity(
                          item.id,
                          comp.complementoGrid,
                          comp.quantidade + 1,
                        ),
  ...
  /// Controle de quantidade pequeno (para complementos)
  Widget _buildQuantityControlSmall({
    required int quantidade,
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.remove, color: _accentRed, size: 16),
            ),
          ),
          // Quantidade
          Container(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.add, color: _accentGreen, size: 16),
            ),
          ),
        ],
      ),
